            ...
            <form class="auth-login-form mt-2" method="POST" action="">
              @csrf
                ...
                <div class="form-group">
                    ...
                    name="email" placeholder="john@exemplo.com" aria-describedby="login-email" tabindex="1" autofocus />
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge form-password-toggle">
                        <input type="password" class="form-control form-control-merge" type="password"
                       id="password"
                       name="password"
                       placeholder="Senha" tabindex="2" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="login-password" />
